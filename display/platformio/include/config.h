...
#define USE_HTTPS_NO_CERT_VERIF // TODO(kgz): find a way to bundle relevant certificates for SL/homelab (or better root certificates?)
...
//   other artifacts.
#define FONT_HEADER "fonts/UbuntuMono_R.h"
...
extern const String PROM_PUSH_HOST;
extern const String PROM_PUSH_URL;
extern const int PROM_PUSH_PORT;
extern const String PROM_PUSH_USER;
extern const String PROM_PUSH_PASS;
extern const String API_HOST;
extern const String SHARED_SECRET;
