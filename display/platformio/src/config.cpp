...
const String PROM_PUSH_HOST = "prometheus-prod-01-eu-west-0.grafana.net";
const String PROM_PUSH_URL = "/api/prom/push";
const int PROM_PUSH_PORT = 443;
const String PROM_PUSH_USER = ENV_PROM_PUSH_USER;
const String PROM_PUSH_PASS = ENV_PROM_PUSH_PASS;

// Backend
const String API_HOST = "weather-display.kevingomez.fr";
const String SHARED_SECRET = ENV_SERVER_SHARED_SECRET;

// LOCATION
// City name that will be shown in the top-right corner of the display.
const String CITY_STRING = "Stockholm";

// TIME
// For list of time zones see
// https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv
const char *TIMEZONE = "CET-1CEST,M3.5.0,M10.5.0/3"; // Europe/Stockholm
